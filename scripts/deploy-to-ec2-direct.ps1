# DAANSETU Backend - Direct EC2 Deployment Script
# This script deploys your code directly to EC2 without Docker Hub
...
Write-Host "🚀 DAANSETU Direct EC2 Deployment" -ForegroundColor Green
